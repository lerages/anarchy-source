...
public final class Optionals {
    ...
    public static Optional<Location> nearbyFreeCardinal(Location start) {
        ...
        if (RegionClipping.isPassable(start.getX() - 1, start.getY(), start.getZ())) {
            return Optional.of(Location.create(start.getX() - 1, start.getY(), start.getZ()));
        }
        ...
        if (RegionClipping.isPassable(start.getX(), start.getY() + 1, start.getZ())) {
            return Optional.of(Location.create(start.getX(), start.getY() + 1, start.getZ()));
        }
    ...
    public static Optional<Location> nearbyFreeInterCardinal(Location start) {
        if (RegionClipping.isPassable(start.getX() - 1, start.getY() - 1, start.getZ())) {
            return Optional.of(Location.create(start.getX() - 1, start.getY() - 1, start.getZ()));
        }
