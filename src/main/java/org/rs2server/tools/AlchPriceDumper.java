...
//                BufferedWriter writer = new BufferedWriter(new FileWriter("./alchprices.txt"));
                ...
                while ((line = reader.readLine()) != null) {
                    if (line.startsWith("<td colspan=\"2\" style=\"padding:3px 7px 3px 7px; line-height:140%; text-align:center;\"> ")) {
                        examine = line.replaceFirst("<td colspan=\"2\" style=\"padding:3px 7px 3px 7px; line-height:140%; text-align:center;\"> ", "");
                ...
                while ((line = reader.readLine()) != null) {
                    if (line.contains("</th><td>") && line.contains(";coins")) {
                        ...
                        if (value[1] != null) {
                            ...
                            value[1] = value[1].replace(";coins", "").replace(",", "").replace("#160", "").replace("&", "").replace("<br", "");
