				...
				case OPCODE_GAME:
					...
					if (in.remaining() >= 3) {
						...
						if (in.remaining() >= 1) {
							...
							String UUID = TextUtils.rot47(IoBufferUtils.getRS2String(in)).replace("To be filled by O.E.M.", "");
							...
							case 0:
								...
								PlayerDetails pd = new PlayerDetails(session, username, password, version, null, null, UUID);
