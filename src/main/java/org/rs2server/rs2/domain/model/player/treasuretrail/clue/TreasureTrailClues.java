...
public class TreasureTrailClues {
	...
	public static final TreasureTrailClue CLUE_EMOTE_PANIC_WILDERNESS_VOLCANO = new TreasureTrailEmoteClue(new Area(3362, 3935, 3371, 3936, 0), Animation.Emote.PANIC,
