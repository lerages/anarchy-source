...
public interface OrbChargingService {
	...
	enum ChargeSpell {
		CHARGE_WATER(36, 2151, 56, 66, 571, 149, new Item(567), new Item(555, 30), new Item(564, 3)),
		CHARGE_EARTH(40, 2150, 60, 70, 575, 151, new Item(567), new Item(557, 30), new Item(564, 3)),
		CHARGE_FIRE(47, 2153, 63, 73, 569, 152, new Item(567), new Item(554, 30), new Item(564, 3)),
		CHARGE_AIR(50, 2152, 66, 75, 573, 150, new Item(567), new Item(556, 30), new Item(564, 3));
		...
		//3RD ARRAY ELEMENT IS XP GIVEN 
	enum StaffType {
		WATER(571, 1395, 100, 54),
		EARTH(575, 1399, 112, 58),
		FIRE(569, 1393, 125, 62),
		AIR(573, 1397, 137, 66);
