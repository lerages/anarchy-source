...
public class FountainOfHeroesServiceImpl implements FountainOfHeroesService {
    ...
    public void rechargeGlories(@Nonnull Player player) {
        ...
        player.getActionSender().sendDialogue("", ActionSender.DialogueType.MESSAGE_MODEL_LEFT, 1712, null, "You feel a power emanating from the fountain as it recharges all your amulets. You can now rub the amulets to teleport and wear them to get more gems whilst mining.");
    }
