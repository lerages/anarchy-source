...
public class ServiceModule extends AbstractModule {
	...
	protected void configure() {
		...
		bind(ForumIntegrationService.class).to(ForumIntegrationServiceImpl.class).in(Singleton.class);
		...
		// Content related services which register game hooks in the constructor MUST be bound eagerly.
       ...
       // bind(RegionMusicService.class).to(RegionMusicServiceImpl.class).asEagerSingleton();
		...
		bind(RunePouchService.class).to(RunePouchServiceImpl.class).asEagerSingleton();
