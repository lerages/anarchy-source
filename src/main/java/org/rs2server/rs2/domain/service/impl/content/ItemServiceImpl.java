...
public class ItemServiceImpl implements ItemService {
	...
	enum Upgradable {
		/**
		 * Takes an empty toxic blowpipe and defines an Upgradable that would result in a full blowpipe upon success.
		 */
		TOXIC_BLOWPIPE_EMPTY(new Item(12924), new Item(12926), UpgradeStrategy.ON_ITEM_USE, (s, p, i, c) -> {
			...
			p.getActionSender().sendMessage("You load " + c.getCount() + "x " + c.getDefinition2().getName() + " into the " + i.getDefinition2().name);
		}, 806, 807, 808, 809, 810, 811, 11230),
		/**
		 * The toxic blowpipe full is the same as the toxic blowpipe empty except it outputs an item the same as it's input, which is
		 * the full blowpipe.
		 */
		TOXIC_BLOWPIPE_FULL(TOXIC_BLOWPIPE_EMPTY.to, TOXIC_BLOWPIPE_EMPTY.to, UpgradeStrategy.ON_ITEM_USE, TOXIC_BLOWPIPE_EMPTY.callback, TOXIC_BLOWPIPE_EMPTY.parameters),

		/**
		 * Serpentine helmets take Zulrah scales to be charged.
		 */
		SERPENTINE_HELM_UNCHARGED(new Item(12929), new Item(12931), UpgradeStrategy.ON_ITEM_USE, TOXIC_BLOWPIPE_EMPTY.callback, 12934),
		SERPENTINE_HELM(SERPENTINE_HELM_UNCHARGED.to, SERPENTINE_HELM_UNCHARGED.to, UpgradeStrategy.ON_ITEM_USE, SERPENTINE_HELM_UNCHARGED.callback, SERPENTINE_HELM_UNCHARGED.parameters),

		/**
		 * Trident of the swamp
		 */
		TRIDENT_OF_THE_SWAMP_UNCHARGED(new Item(12900), new Item(12899), UpgradeStrategy.ON_ITEM_USE, TOXIC_BLOWPIPE_EMPTY.callback, 12934),
		TRIDENT_OF_THE_SWAP(TRIDENT_OF_THE_SWAMP_UNCHARGED.to, TRIDENT_OF_THE_SWAMP_UNCHARGED.to, UpgradeStrategy.ON_ITEM_USE, TRIDENT_OF_THE_SWAMP_UNCHARGED.callback, TRIDENT_OF_THE_SWAMP_UNCHARGED.parameters),
		/**
		 * Toxic staff of the dead
		 */
		TOXIC_STAFF_UNCHARGED(new Item(12902), new Item(12904), UpgradeStrategy.ON_ITEM_USE, TOXIC_BLOWPIPE_EMPTY.callback, 12934),
		TOXIC_STAFF_OF_THE_DEAD(TOXIC_STAFF_UNCHARGED.to, TOXIC_STAFF_UNCHARGED.to, UpgradeStrategy.ON_ITEM_USE, TOXIC_STAFF_UNCHARGED.callback, TOXIC_STAFF_UNCHARGED.parameters),
		/**
		 * Tanzanite helmets are the same as Serpentine helmets, except with different to and from ids.
		 */
		TANZANITE_HELM_UNCHARGED(new Item(13196), new Item(13197), UpgradeStrategy.ON_ITEM_USE, SERPENTINE_HELM_UNCHARGED.callback, SERPENTINE_HELM_UNCHARGED.parameters),
		TANZANITE_HELM(TANZANITE_HELM_UNCHARGED.to, TANZANITE_HELM_UNCHARGED.to, UpgradeStrategy.ON_ITEM_USE, SERPENTINE_HELM.callback, SERPENTINE_HELM.parameters),

		/**
		 * Magma helmets are the same as Serpentine helmets, except with different to and from ids.
		 */
		MAGMA_HELM_UNCHARGED(new Item(13198), new Item(13199), UpgradeStrategy.ON_ITEM_USE, SERPENTINE_HELM_UNCHARGED.callback, SERPENTINE_HELM_UNCHARGED.parameters),
		MAGMA_HELM(MAGMA_HELM_UNCHARGED.to, MAGMA_HELM_UNCHARGED.to, UpgradeStrategy.ON_ITEM_USE, SERPENTINE_HELM.callback, SERPENTINE_HELM.parameters),

		PRIMORDIAL_CRYSTAL(new Item(13231), new Item(13239), UpgradeStrategy.ON_ITEM_USE, (s, p, i, c) -> {
			p.getActionSender().sendMessage("You combine the crystal with your boots to create "+i.getDefinition2().getName()+".");
			p.getSkills().addExperience(Skills.MAGIC, 200);
			p.getSkills().addExperience(Skills.RUNECRAFTING, 200);
		}, 11840),

		ABYSSAL_DAGGER_POISON(new Item(13265), new Item(13271), UpgradeStrategy.ON_ITEM_USE, (s, p, i, c) -> p.getActionSender().sendMessage("You combine the poison with the Abyssal dagger"), 187),

		PEGASIAN_CRYSTAL(new Item(13229), new Item(13237), UpgradeStrategy.ON_ITEM_USE, PRIMORDIAL_CRYSTAL.callback, 2577),

		ETERNAL_CRYSTAL(new Item(13227), new Item(13235), UpgradeStrategy.ON_ITEM_USE, PRIMORDIAL_CRYSTAL.callback, 6920),

		DYNAMITE_POT(new Item(13572), new Item(13571, 1), UpgradeStrategy.ON_ITEM_USE, (s, p, i, c) -> p.getActionSender().sendMessage("You combine the sulphur and pot to create "+i.getDefinition2().getName()+"."), 1931),
		
		DYNAMITE(new Item(13573), new Item(13572, 1), UpgradeStrategy.ON_ITEM_USE, (s, p, i, c) -> p.getActionSender().sendMessage("You combine the ball of wool and dynamite pot to create "+i.getDefinition2().getName()+"."), 1759),
		
		INFERNAL_AXE(new Item(13233), new Item(13241), UpgradeStrategy.ON_ITEM_USE, (s, p, i, c) -> p.getActionSender().sendMessage("You combine the smouldering stone with your Dragon axe to create "+i.getDefinition2().getName()+"."), 6739),

		INFERNAL_PICKAXE(new Item(13233), new Item(13243), UpgradeStrategy.ON_ITEM_USE, (s, p, i, c) -> p.getActionSender().sendMessage("You combine the smouldering stone with your Dragon pickaxe to create "+i.getDefinition2().getName()+"."), 11920),
		
		INFERNAL_HARPOON(new Item(13233), new Item(21031), UpgradeStrategy.ON_ITEM_USE, (s, p, i, c) -> p.getActionSender().sendMessage("You combine the smouldering stone with your Dragon Harpoon to create "+i.getDefinition2().getName()+"."), 21028),

		EMBLEM_TIER_ONE(new Item(12746), new Item(12748), UpgradeStrategy.ON_KILL, (s, p, i, u) -> p.getActionSender().sendMessage("Your emblem has been upgraded to the next tier."), 12746),
		EMBLEM_TIER_TWO(new Item(12748), new Item(12749), UpgradeStrategy.ON_KILL, EMBLEM_TIER_ONE.callback, 12748),
		EMBLEM_TIER_THREE(new Item(12749), new Item(12750), UpgradeStrategy.ON_KILL, EMBLEM_TIER_ONE.callback, 12749),
		EMBLEM_TIER_FOUR(new Item(12750), new Item(12751), UpgradeStrategy.ON_KILL, EMBLEM_TIER_ONE.callback, 12750),
		EMBLEM_TIER_FIVE(new Item(12751), new Item(12752), UpgradeStrategy.ON_KILL, EMBLEM_TIER_ONE.callback, 12751),
		EMBLEM_TIER_SIX(new Item(12752), new Item(12753), UpgradeStrategy.ON_KILL, EMBLEM_TIER_ONE.callback, 12752),
		EMBLEM_TIER_SEVEN(new Item(12753), new Item(12754), UpgradeStrategy.ON_KILL, EMBLEM_TIER_ONE.callback, 12753),
		EMBLEM_TIER_EIGHT(new Item(12754), new Item(12755), UpgradeStrategy.ON_KILL, EMBLEM_TIER_ONE.callback, 12754),
		EMBLEM_TIER_NINE(new Item(12755), new Item(12756), UpgradeStrategy.ON_KILL, EMBLEM_TIER_ONE.callback, 12755);
		/**
		...
		Upgradable(@Nonnull Item from, @Nonnull Item to, @Nonnull UpgradeStrategy strategy, @Nonnull QuadConsumer<ItemService, Player, Item, Item> callback, @Nonnull int... parameters) {
			this(from, to, strategy, callback, Arrays.asList(parameters).stream().flatMapToInt(IntStream::of).boxed().map(Item::new).collect(toList()));
		}

		Upgradable(@Nonnull Item from, @Nonnull Item to, @Nonnull UpgradeStrategy strategy, @Nonnull QuadConsumer<ItemService, Player, Item, Item> callback, @Nonnull List<Item> parameters) {
			this.from = from;
			this.to = to;
		...
		/**
		 * Creates an {@link Optional} that may or may not return an {@link org.rs2server.rs2.domain.service.impl.content.ItemServiceImpl.Upgradable}
		 * depending on if an Upgradable exists that takes the given item and parameter as input.
		 *
		 * @param item      The item to find an upgradable for.
		 * @param parameter The parameter item that is to be passed to the callback.
		 * @return An optional.
		 */
		@Nonnull
	...
	public enum Degradable {
		//DHAROK_FULL_HELM(1000, new Item[]{ new Item(4716), new Item(4880), new Item(4881), new Item(4882), new Item(4883), new Item(4884)}, true),

		ABYSSAL_TENTACLE(10000, 10000, DegradationStrategy.ON_ATTACK, new Item[]{new Item(12006), new Item(12004)}, false),

//		TRIDENT_OF_THE_SEAS(1, 10000, DegradationStrategy.ON_ATTACK, new Item[]{new Item(11905), new Item(11907), new Item(11908)}, false),

		TOXIC_BLOWPIPE(0, 0, DegradationStrategy.ON_ATTACK, new Item[]{new Item(12926), new Item(12924)}, false),
		TOXIC_STAFF_OF_THE_DEAD(0, 0, DegradationStrategy.ON_ATTACK, new Item[] {new Item(12904), new Item(12902)}, false),
		TRIDENT_OF_THE_SWAMP(0, 0, DegradationStrategy.ON_ATTACK, new Item[]{new Item(12899), new Item(12900)}, false),
		...
		Degradable(int initialCharge, int charges, DegradationStrategy degradationStrategy, Item[] items, boolean barrows) {
		...
		/**
		 * Returns a degradable for a given item (can be any stage in the degradation process)
		 *
		 * @param item The item
		...
		public static Degradable forItem(@Nonnull Item item) {
			return Arrays.stream(Degradable.values())
					.filter(d -> Arrays.stream(d.items).anyMatch(i -> i.getId() == item.getId()))
	...
	public boolean isFullyDegraded(@Nonnull Item item) {
		...
		return degradable != null && ArrayUtils.indexOf(degradable.getItems(), item) == degradable.getItems().length - 1;
	}
	...
	public void degradeItem(@Nonnull Mob mob, Item item) {
		...
		final int charges = remove ? (player.getDatabaseEntity().getEquipment().getItemCharges().getOrDefault(item.getId(), degradable.getInitialCharge()) - 1) :
				player.getDatabaseEntity().getEquipment().getItemCharges().getOrDefault(item.getId(), degradable.getInitialCharge());
		mob.removeAttribute("avaEffect");
		if (charges <= 0) {
			logger.info("Degrading...");
			...
			player.getDatabaseEntity().getEquipment().getItemCharges().put(replacement.getId(), degradable.getCharges());
		} else {
	...
	public int getNetWorth(@Nonnull Player player) {
		...
		for (Item inv : player.getInventory().toArray()) {
			...
			worth += inv.getDefinition().getStorePrice() * inv.getCount();
		}
		...
		for (Item equip : player.getEquipment().toArray()) {
			...
			worth += equip.getDefinition().getStorePrice() * equip.getCount();
		}
		return worth;
	}
	...
	public Container[] getItemsKeptOnDeath(@Nonnull Player player) {
		int count = 3;
		if (player.getCombatState().getPrayer(Prayers.PROTECT_ITEM) || player.getAttribute("protectItem") == Boolean.TRUE) {
			count++;
		...
		Collections.sort(items, (o1, o2) -> {
			...
			if (o1.getDefinition2().getCost() == o2.getDefinition2().getCost()) {
				return o1.getDefinition().getStorePrice() > o2.getDefinition().getStorePrice() ? -1 : 1;
			}
			return 1;
		});
	...
	public void gambleFireCapes(@Nonnull Player player, int amount) {
		...
		for (int i = 0; i < amount; i++) {
			...
			if (Misc.random(100) == 1 && player.getPet() == null) {
				...
				Pet myPet = new Pet(player, 5892);
				player.setPet(myPet);
				settings.setPetSpawned(true);
				settings.setPetId(5892);
				World.getWorld().register(myPet);
