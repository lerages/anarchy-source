...
public interface SlayerService {
	...
	BitConfigBuilder rowBuilder(@Nonnull final SlayerTask.TaskGroup[] blockedTasks);
	...
	/**
	 * Opens the player's slayer logging, displaying the amount of kills per npc.
	 * @param player The player.
	 */
	void openSlayerLog(@Nonnull Player player);
