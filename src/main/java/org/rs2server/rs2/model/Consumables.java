...
public class Consumables {
	...
	public static enum Food 
	{
		 ...
		 * @param heal The amount of health this food heals.
		 * @param newId The item id of the new item to add.
		 */
	...
	public static enum Drink {
		...
		SUPER_COMBAT_POTION(new int[] { 12701, 12699, 12697, 12695 }, new int[] { Skills.ATTACK, Skills.STRENGTH, Skills.DEFENCE }, PotionType.SUPER_POTION),
