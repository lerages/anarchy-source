...
public class LunarDiplomacy extends Quest<LunarStates> {
    ...
    public void openDialogue(int dialogue) {
        ...
        switch (dialogue) {
            case 0:
                sendDialogue("Lokar", DialogueType.NPC, 3855, FacialAnimation.DEFAULT, "You there! Please, I beg of your assistance!!");
            ...
            case 1:
                ...
                break;
            case 2:
                sendDialogue("Lokar", DialogueType.NPC, 3855, FacialAnimation.DEFAULT, "Thank Saradomin! Off the shores of Lunar Isle dwells a terrifying sea snake. Can you slay such a beast");
            ...
            case 3:
                ...
                break;
            case 4:
                sendDialogue("", DialogueType.OPTION, -1, null, "I am always up for a challenge!|I don't think I'm ready for that!");
                setNextDialogueId(0, 18);
                setNextDialogueId(1, 3);
                break;
            case 5:
                setState(LunarStates.STARTED);
                player.getActionSender().sendConfig(quest_config, 1);
                sendDialogue("Lokar", DialogueType.NPC, 3855, FacialAnimation.DEFAULT, "Adventurer, this is no normal snake. We must have a plan to defeat it.");
                setNextDialogueId(0, 6);
                break;
            case 6:
                sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "It sounds awfully strong. Do you know what we need to bring it down?");
                setNextDialogueId(0, 19);
                break;
            case 7:
                sendDialogue("Lokar", DialogueType.NPC, 3855, FacialAnimation.DEFAULT, "I have been tracking and studying the snake over the past few days. Take this scroll of information that I have gathered. Make sure she gets it.");
                setNextDialogueId(0, 8);
                break;
            case 8:
                Inventory.addDroppable(player, scroll);
                sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Okay. Where can I find this mage?");
                setNextDialogueId(0, 9);
                break;
            case 9:
                sendDialogue("Lokar", DialogueType.NPC, 3855, FacialAnimation.DEFAULT, "I suggest searching on the Lunar Isle. Would you like a teleport?");
            ...
            case 10:
                ...
                break;
            case 11:
                sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Yes, please. I am ready.");
            ...
            case 12:
                ...
                break;
            case 13:
                sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Are you the mage that can help me?");
                setNextDialogueId(0, 14);
                break;
            case 14:
                sendDialogue("Meteora", DialogueType.NPC, 3839, FacialAnimation.DEFAULT, "Who sojourns the lair of Meteora?");
                setNextDialogueId(0, 15);
                break;
            case 15:
                sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Relax! There is a giant Sea Snake terrorising the town. Is there any way you can help?");
                setNextDialogueId(0, 16);
                break;
            case 16:
                sendDialogue("Meteora", DialogueType.NPC, 3839, FacialAnimation.DEFAULT, "I will need more information about this Snake.");
                setNextDialogueId(0, 17);
                break;
            case 17:
                if (player.getInventory().hasItem(scroll)) {
                    player.getInventory().remove(scroll);
                    sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "This is what the old man Lokar has learned so far about the snake.");
                    setNextDialogueId(0, 20);
                } else {
                    sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "I seem to have lost the scroll, I'll come back when I have it.");
            ...
            case 18://LOKAR
                ...
                break;
            case 19:
                sendDialogue("Lokar", DialogueType.NPC, 3855, FacialAnimation.DEFAULT, "I don�t know for sure, but legend has it there is a mage named Meteora who is a master of magic. Maybe she could help you.");
                setNextDialogueId(0, 7);
                break;
            case 20:
                sendDialogue("Meteora", DialogueType.NPC, 3839, FacialAnimation.DEFAULT, "Oh my. This is serious. The snake, if we should even call it that, is not a normal one. It was summoned by a Zamorakian mage. We can only kill it using something special.");
                setNextDialogueId(0, 21);
                break;
            case 21:
                sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "What do you mean something special?");
                setNextDialogueId(0, 22);
                break;
            case 22:
                sendDialogue("Meteora", DialogueType.NPC, 3839, FacialAnimation.DEFAULT, "Tell me, Adventurer. Are you skilled with the art of fletching and magic?");
                setNextDialogueId(0, 23);
                break;
            case 23:
                sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Yes, I believe I am skilled enough.");
                setNextDialogueId(0, 24);
                break;
            case 24:
                sendDialogue("Meteora", DialogueType.NPC, 3839, FacialAnimation.DEFAULT, "There are special bolts that you must fletch and bless. Only the power of Saradomin can smite such a beast.");
                setNextDialogueId(0, 25);
                break;
            case 25:
                sendDialogue("Meteora", DialogueType.NPC, 3839, FacialAnimation.DEFAULT, "Use your magic skills to enchant at least ten bolts.");
            ...
            case 27:
                ...
                break;
            case 28:
                sendDialogue("Meteora", DialogueType.NPC, 3839, FacialAnimation.DEFAULT, "How's the progress with the magical bolts?");
                setNextDialogueId(0, 29);
                break;
            case 29:
                sendDialogue("", DialogueType.OPTION, -1, null, "I think I have enough! I'm ready!|Not yet, I think I need more.");
            ...
            case 31:
                if (hasEnchantedBolts()) {
                    ...
                    sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "I don't have the bolts yet.");
                    setNextDialogueId(0, 27);
                }
                break;
            case 32:
                sendDialogue("Meteora", DialogueType.NPC, 3839, FacialAnimation.DEFAULT, "Perfect, now all you have to do is kill the sea snake!");
                setNextDialogueId(0, 33);
                break;
            case 33:
                sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Great! Where can I find the Sea Snake?");
                setNextDialogueId(0, 34);
                break;
            case 34:
                sendDialogue("Meteora", DialogueType.NPC, 3839, FacialAnimation.DEFAULT, "Good question. I have no idea! I suggest asking around, someone has to know.");
            ...
            case 37:
                ...
                break;
            case 38:
                sendDialogue("", DialogueType.OPTION, -1, null, "Do you know where the Sea Snake is?|Can you take me to Lunar Isle");
                setNextDialogueId(0, 39);
                setNextDialogueId(1, 204);
                break;
            case 39:
                sendDialogue("Lokar", DialogueType.NPC, 3855, FacialAnimation.DEFAULT, "I happen to know how to get you there! Would you like to go?");
            ...
            case 43:
                ...
                World.getWorld().submit(new Tickable(3) {
                    ...
                    public void execute() {
                        this.stop();
                        NPC n = new NPC(1101, Location.create(2107, 3957), Location.create(2107, 3957), Location.create(2107, 3957), NormalDirection.SOUTH.intValue());
                ...
                break;
            case 44:
                sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "I've done it! I've killed the Snake!");
                setNextDialogueId(0, 45);
                break;
            case 45:
                sendDialogue("Lokar", DialogueType.NPC, 3855, FacialAnimation.DEFAULT, "Well Done! You've saved the City of Lunar Isle.");
                setNextDialogueId(0, 46);
                break;
            case 46:
                sendDialogue("Lokar", DialogueType.NPC, 3855, FacialAnimation.DEFAULT, "As a reward, You can speak to me to purchase items from me and Teleport to Lunar Isle to use Lunar Magics.");
                setNextDialogueId(0, 47);
                break;
            case 47:
                setState(LunarStates.COMPLETED);
                player.removeAttribute("questnpc");
                player.getActionSender().sendMessage("Congratulations you've finished Lunar Isle, You can now speak to Lokar to Teleport to Lunar Isle and purchase items.");
                player.getActionSender().removeChatboxInterface();
                player.getActionSender().sendConfig(quest_config, 2);
                break;
            ...
            case 200:
                ...
                break;
            case 201:
                sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.ANNOYED, "No time to talk! I�ve got a sea snake to slay");
                setNextDialogueId(0, 202);
                break;
            case 202:
                sendDialogue("Lokar", DialogueType.NPC, 3855, FacialAnimation.DEFAULT, "So would you like me to take you back to Lunar Isle again?");
        ...
        if (started) {
            switch (state) {
                ...
                case SNAKE:
                    ...
                    player.getActionSender().sendString(275, 10, "Now I just need to find him...Maybe i should speak with Lokar.");
                ...
                case KILLED_SNAKE:
                    ...
                    player.getActionSender().sendString(275, 10, "<str>Now I just need to find him...Maybe i should speak with Lokar.");
                ...
                case COMPLETED:
                    ...
                    player.getActionSender().sendString(275, 16, "<col=000080>Access to Lunar Magiks");
    ...
    public boolean hasEnchantedBolts() {
        for (int i = 9236; i <= 9245; i++) {
            ...
            if (player.getEquipment().get(Equipment.SLOT_ARROWS) != null && player.getEquipment().get(Equipment.SLOT_ARROWS).getId() == i) {
                return true;
            }
        }
        return false;
