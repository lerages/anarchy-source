...
public class DesertTreasure extends Quest<DTStates> {
	...
	public void openDialogue(int dialogue) {
		...
		case 0:// not enough 
			...
			break;
		case 1:
			player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Who are you and why are you here?");
			setNextDialogueId(0, 2);
			break;
		case 2:
			sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "I've been doing research in the desert on a new form of Magical Spells,<br>I've learned that they are located somewhere in the desert.");
			setNextDialogueId(0, 3);
			break;
		case 3:
			sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "Would you like to help me uncover the secrets of this new magic form?");
		...
		case 5:
			if (!hasRequirements()) {
				sendDialogue("", DialogueType.MESSAGE, -1, null, "You don't have the requirements to start this quest.");
		...
		case 6:
			...
			break;
		case 7:
			sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "Great to begin, We need to do more research on these great magics, Go to the varrock museum and speak to Historian Minas.");
			setNextDialogueId(0, CLOSE);
		...
		case 8:
			...
			break;
		case 9:
			player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "The Archaeologist from Al-Kharid sent me to speak to you about some form of new magics.");
			setNextDialogueId(0, 10);
			break;
		case 10:
			sendDialogue("Historian Minas", DialogueType.NPC, 1902, FacialAnimation.DEFAULT, "Ahh right i've been expecting you. I've prepared a book for you to give to the archaeologist.");
			setNextDialogueId(0, 11);
			break;
		case 11:
			if (player.getInventory().add(new Item(7633, 1))) {
				sendDialogue("Historian Minas", DialogueType.NPC, 1902, FacialAnimation.DEFAULT, "I've just given you the book, Take it back to the archaeologist as soon as possible!");
			...
			break;
		case 13:
			player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Okay, Thanks!");
			setNextDialogueId(0, -1);
			break;
		/**
		 * State = TWO
		 */
		case 14:
			sendDialogue("Historian Minas", DialogueType.NPC, 1902, FacialAnimation.DEFAULT, "Take the book i've given you to the archaeologist.");
			setNextDialogueId(0, -1);
			player.removeAttribute("questnpc");
			break;
		case 15:
			sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "Hello, What news do you return with?");
		...
		case 16:
			...
			if (hasBook) {
				player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Historian Minas has told me to report back to you with this ancient book.");
			} else {
				player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Historian Minas has told me to report back to you with an ancient book, But i seem to have misplaced it.");
			}
			setNextDialogueId(0, next);
			break;
		case 17:
			sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "Wonderful now let me see the book.");
			setNextDialogueId(0, 19);
			break;
		case 18:
			sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "I recommend you go find it.");
			setNextDialogueId(0, -1);
			player.removeAttribute("questnpc");
			break;
		case 19:
			player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Sure");
			setNextDialogueId(0, 20);
			break;
		case 20:
			player.getInventory().remove(new Item(7633, 1));
			sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "Wow, this is quite amazing...");
			setNextDialogueId(0, 21);
			break;
		case 21:
			sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "It seems that their are 5 warlords that defend these magics from the unworthy.");
			setNextDialogueId(0, 22);
			break;
		case 22:
			sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "To unlock the magics you must defeat the 5 warlords and claim each of their respective diamonds.");
			setNextDialogueId(0, 23);
			break;
		case 23:
			sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "Do you think you're up for the task?");
		...
		case 24:
			...
			break;
		case 25:
			sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "Awesome! Come back to me when you're ready to take on the task and I can take you to the warlords.");
		 ...
		 */
		case 27:
			sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "Would you like to start taking on the warlords?");
			setState(DTStates.THREE);
		...
		case 28:
			...
			break;
		case 29:
			sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "Alright, I will take you to the first warlord you need to defeat.");
		...
		case 31:
			...
			World.getWorld().submit(new Tickable(3) {
				...
				public void execute() {
					this.stop();
					NPC n = new NPC(3459, Location.create(3570, 3406), Location.create(3570, 3406), Location.create(3570, 3406), NormalDirection.NORTH_EAST.intValue());
		...
		case 32:
			if (player.getInventory().hasItem(BLOOD_DIAMOND)) {
				...
				sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "Great job on defeating Dessous, Would you like me to take you to the next warlord?");
		...
		case 34:
			...
			World.getWorld().submit(new Tickable(3) {
				...
				public void execute() {
					this.stop();
					NPC n = new NPC(3458, Location.create(2865, 3765), Location.create(2865, 3765), Location.create(2865, 3765), NormalDirection.SOUTH_WEST.intValue());
					World.getWorld().register(n);
					n.setInstancedPlayer(player);
					player.setAttribute("ownedNPC", n);
					n.getCombatState().startAttacking(player, player.isAutoRetaliating());
		...
		case 36:
			if (player.getInventory().hasItem(ICE_DIAMOND)) {
				...
				sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "Great job on defeating Kamil, Would you like me to take you to the next warlord?");
		...
		case 38:
			...
			World.getWorld().submit(new Tickable(3) {
				...
				public void execute() {
					this.stop();
					NPC n = new NPC(3456, Location.create(3313, 9376), Location.create(3313, 9376), Location.create(3313, 9376), NormalDirection.SOUTH_EAST.intValue());
					World.getWorld().register(n);
					n.setInstancedPlayer(player);
					player.setAttribute("ownedNPC", n);
					n.getCombatState().startAttacking(player, player.isAutoRetaliating());
		...
		case 39:
			if (player.getInventory().hasItem(SMOKE_DIAMOND)) {
				...
				sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "Great job on defeating Fareed, Would you like me to take you to the next warlord?");
		...
		case 41:
			...
			World.getWorld().submit(new Tickable(3) {
				...
				public void execute() {
					this.stop();
					NPC n = new NPC(683, Location.create(2738, 5085), Location.create(2738, 5085), Location.create(2738, 5085), NormalDirection.SOUTH_WEST.intValue());
					World.getWorld().register(n);
					n.setInstancedPlayer(player);
					player.setAttribute("ownedNPC", n);
					n.getCombatState().startAttacking(player, player.isAutoRetaliating());
		...
		case 42:
			if (player.getInventory().hasItem(SHADOW_DIAMOND)) {
				...
				sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "Great job on defeating Damis, That was the final warlord to defeat now we can unlock the secrets to this new magic.");
		 ...
		 */
		case 43:
			sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "Let me go ahead and add the collected diamonds to the book to unveil the secrets to this new magic.");
			setNextDialogueId(0, 44);
			break;
		case 44:
			player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "I can feel the ancient magics flowing through me...");
			setNextDialogueId(0, 45);
			break;
		case 45:
			player.getActionSender().removeChatboxInterface();
			player.removeAttribute("questnpc");
			player.getActionSender().sendMessage("Congratulations you've finished Desert Treasure, You can now speak to The Archaeologist to switch magics and purchase items.");
		 ...
		 */
		case 46:
			sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "Welcome back! How can I help you?");
		...
		case 49:
			...
			SpellBook book = ancients ? MagicCombatAction.SpellBook.MODERN_MAGICS : MagicCombatAction.SpellBook.ANCIENT_MAGICKS;
			player.getActionSender().sendConfig(439, config);
			player.getCombatState().setSpellBook(book.getSpellBookId());
			break;
			
		case 60:
			sendDialogue("Archaeologist", DialogueType.NPC, 684, FacialAnimation.DEFAULT, "Come back when you have the blood diamond.");
			setNextDialogueId(0, 47);
			break;
	...
	public void showQuestInterface() {
		...
		if (started) {
			...
			case THREE:
				player.getActionSender().sendString(275, 4, "<str>The Archaeologist has asked me to speak to");
				player.getActionSender().sendString(275, 5, "<str>Historian Minas in the Varrock museum.");
				player.getActionSender().sendString(275, 6, "<str>Historian Minas has asked me to take the book back to");
			...
			case FOUR:
				...
				player.getActionSender().sendString(275, 6, "<str>Historian Minas has asked me to take the book back to");
				player.getActionSender().sendString(275, 7, "<str>The Archaeologist.");
				player.getActionSender().sendString(275, 8, "<str>I must defeat the 5 warlords, Speak to the Archaelogist");
			...
			case COMPLETED:
				...
				player.getActionSender().sendString(275, 18, "<col=000080>Access to Ancient Magiks");
