...
public class Equipment {
	 ...
	 */
	public static int[] ZAMORAK_ITEMS = new int[] { 1033, 1035, 2414, 2653, 2655, 2657, 2659, 3478, 6764, 11700, 1724, 3842, 10368, 10370, 10372, 10374, 10444, 10450, 10456, 10460, 10468, 10474, 10776, 10786, 10790, 11716 };
	
	/**
	 * Saradomin related items.
	 */
	public static int[] SARADOMIN_ITEMS = new int[] { 3840, 2412, 2415, 2661, 2663, 2665, 2667, 3479, 6762, 11698, 10384, 10386, 10388, 10390, 10440, 10446, 10452, 10458, 10464, 10470, 10778, 10784, 10792, 11730 };
	 ...
	 * Arrays for sounds
	 */
	public static int[] METAL_GLOVES = new int[] {};
	
	public static int[] METAL_BOOTS = new int[] {};
	
	public static int[] SOFT_CLOTHING = new int[] {};
	
	public static int[] PLATEBODY = new int[] {};
	
	public static int[] HELM = new int[] {};
	
	public static int[] LEATHER = new int[] {};
	
	public static int[] PLATELEGS = new int[] {};
	
	public static int[] RANGED_WEAPONS = new int[] {};
	
	public static int[] CRUSH_WEAPONS = new int[] {};
	
	public static int[] STAVES = new int[] {};
	
	public static int[] SWORDS = new int[] {};
