...
public final class ExperienceDropdown {
    ...
    @Override
    public final int hashCode() {// ooo  gonna try something dunno if its correct but we will see
        return getSelectedValue() | getExperienceBarValue() | player.getDatabaseEntity().getPlayerSettings().getAlignment() | player.getDatabaseEntity().getPlayerSettings().getFontSize();
    }
