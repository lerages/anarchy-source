...
public class Banking {
	...
	public void sendTabConfig() {
		...
		//player.getActionSender().sendConfig(115, (player.getSettings().isWithdrawingAsNotes() ? 1 : 0currentTab * 4);
	}
	...
	public void openPlayerBank(Player ban) {
		...
		player.getActionSender().sendInterfaceInventory(
				15);
		player.getActionSender().sendString(12, 4, "The Bank of RuneScape");
