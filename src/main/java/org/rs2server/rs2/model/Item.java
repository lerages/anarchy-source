 ...
 * ANY CHANGES CAN POSSIBLY BREAK (DE-)SERIALIATION TO THE DATABASE AND REQUIRE CAREFUL ATTENTION.
 *
 * Yours truly,
 * tommo and the wrath which will be bestowed upon you if you do.
 */
public class Item {
    ...
    /**
     * Flag whether or not this item is a PVP drop.
     * This is transient and ignored so that it's never serialized.
     */
    @JsonIgnore
     ...
     *
     * @param amount The amount to increase the original count with.
     */
	@JsonIgnore
