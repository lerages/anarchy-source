...
public class RegionClipping {
    ...
    public static void addClipping(GameObject obj) {
        ...
        int height = obj.getSpawnLocation().getZ();
        int xLength;
        int yLength;
...
//        int type = obj.getType();
     ...
     /*   if (type == 22) {
            ...
            if (def.clipType != 0) {
                addClippingForSolidObject(x, y, height, xLength, yLength, true);
            }
        } else if (type >= 0 && type <= 3) {
            if (def.clipType != 0) {
                addClippingForVariableObject(x, y, height, type, obj.getDirection(), true);
            }
        }*/
//		if (obj.getLocation().equals(Location.create(3081, 3510)) || obj.getLocation().equals(Location.create(3078, 3510))) {
//			addClipping(obj.getLocation().getX() + 1, y, height, 0x200000);
//		}
//		if (obj.getLocation().equals(Location.create(2474, 3435))) {
//			for (int i = 0; i < 6; i++) {
//				addClipping(obj.getLocation().getX(), obj.getLocation().getY() - i, height, 0x200000);
//			}
//		}
    }
   ...
   /*     if (obj.getType() == 22) {
            ...
            if (def.clipType != 0) {
                removeClippingForSolidObject(x, y, height, xLength, yLength, true);
            }
        } else if (obj.getType() >= 0 && obj.getType() <= 3) {
            if (def.clipType != 0) {
                removeClippingForVariableObject(x, y, height, obj.getType(), obj.getDirection(), true);
            }
        }*/
    }
