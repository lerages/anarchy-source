...
public class Sound 
{
    ...
    public static final Sound EQUIP_METAL_GLOVES = Sound.create(2236, 0); //Daggers, scims, short, 2h and longswords.
    public static final Sound EQUIP_BOOTS = Sound.create(2237, 0);
    public static final Sound EQUIP_SOFT = Sound.create(2238, 0); //leather boots/clothes, robes, jewellery
    public static final Sound EQUIP_PLATEBODY = Sound.create(2239, 0);
    public static final Sound EQUIP_HELM = Sound.create(2240, 0);
    public static final Sound EQUIP_LEATHER = Sound.create(2241, 0);
    public static final Sound EQUIP_PLATELEGS = Sound.create(2242, 0);
    public static final Sound EQUIP_RANGED_WEAPON = Sound.create(2244, 0); //bows/crossbows
    public static final Sound EQUIP_SHIELD = Sound.create(2245, 0);
    public static final Sound EQUIP_CRUSH_WEP = Sound.create(2246, 0); //mace/battleaxe/pickaxe
    public static final Sound EQUIP_STAFF = Sound.create(2247, 0);
    public static final Sound EQUIP_SWORD = Sound.create(2248, 0); //Daggers, scims, short, 2h and longswords.
    ...
    public static final Sound CANNON_DROP = Sound.create(2876, 0);
    public static final Sound CANNON_FIRING = Sound.create(3301, 0);
    /**
     * Misc related world
     */
    ...
    public static final Sound SMELTING = Sound.create(2725, 0);
    public static final Sound SMITHING = Sound.create(3771, 0);
    ...
    public static final Sound MYSTIC_MIGHT = Sound.create(2669, 0);
    public static final Sound MYSTIC_WILL = Sound.create(2670, 0);
    ...
    public static final Sound CHIVALRY = Sound.create(2682, 0);
    ...
    public static final Sound MODERN_TELE = Sound.create(200,  0);
    public static final Sound MODERN_END_TELE = Sound.create(201,  0);
