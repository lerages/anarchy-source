...
public class PestControlManager extends EventListener {
	...
	public static final int[][] PC_NPCS =	new int[][]{ 
		{1694, 1695, 1696, 1697, 1714, 1715, 1716, 1717, 1718, 1709, 1710, 1711, 1724, 1725, 1726, 1727, 1734, 1735, 1736, 1737, 1689},
		{3736, 3737, 3738, 3739, 3756, 3757, 3758, 3759, 3749, 3766, 3767, 3744,  3768, 3769, 3773, 3774, 3775, 3727, 3728, 3729, 3730}, 
	...
	public enum Boat {
		NOVICE(40, 14315, Location.create(2657, 2639, 0), Location.create(2660, 2639, 0)), INTERMEDIATE(70, 25631, Location.create(2644, 2644, 0), Location.create(2641, 2644, 0)), EXPERT(100, 25632, Location.create(2638, 2653, 0), Location.create(2635, 2653, 0));
	...
	public enum Portal {
		WEST(1747, 18, Location.create(2628, 2591, 0), new Location[]{
		...
		EAST(1748, 20, Location.create(2680, 2588, 0), new Location[] {
		...
		SOUTH_EAST(1749, 22, Location.create(2669, 2570, 0), new Location[] {
		...
		SOUTH_WEST(1750, 24, Location.create(2645, 2569, 0), new Location[] {
