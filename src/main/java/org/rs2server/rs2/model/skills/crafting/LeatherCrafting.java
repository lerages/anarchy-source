...
public class LeatherCrafting {
	...
	public static final LeatherProduction[] HARD_LEATHER_PRODUCTIONS = {
		LeatherProduction.HARD_LEATHER_BODY
	};
	...
	public static final LeatherProduction[] XERICIAN_PRODUCTIONS = {
		LeatherProduction.XERICIAN_HAT, LeatherProduction.XERICIAN_ROBE, LeatherProduction.XERICIAN_TOP
	};
	...
	public enum Leather {
		...
		HARD_LEATHER(28, new Item(1743), LeatherCrafting.HARD_LEATHER_PRODUCTIONS, "hard leather"),
	...
	public enum LeatherChilds {
		...
		LeatherChilds(LeatherProduction leatherProduction, int[] child, int itemId, double experience, int levelRequired) {
			...
			if (leather == Leather.NORMAL_LEATHER) {
				...
				if (leather == Leather.HARD_LEATHER) {
					...
					player.getActionSender().sendString(
							...
							6,
							"<br><br><br><br>"
									+ CacheItemDefinition.get(leatherProduction.itemId).getName());
					...
					for (int index = 0; index < leather.possibleProductions.length; index++) {
						...
						player.getActionSender().sendString(304, (index + 2) * 4, "<br><br><br><br>"+leatherProduction.getName());
					}
