...
public enum Talisman {
	...
	AIR_TALISMAN(1438, 5527, 1, 1, Location.create(3129, 3405, 0), Location.create(2841, 4829, 0), 2452, 2478,556, 5, false),
	MIND_TALISMAN(1448, 5529, 2, 2, Location.create(2980, 3513, 0), Location.create(2792, 4828, 0), 2453, 2479, 558, 5.5, false),
	WATER_TALISMAN(1444, 5531, 4, 5, Location.create(3187, 3164, 0), Location.create(3494, 4833, 0), 2454, 2480, 555, 6, false),
	EARTH_TALISMAN(1440, 5535, 8, 9, Location.create(3304, 3474, 0), Location.create(2656, 4829, 0), 2455, 2481, 557, 6.5, false),
	FIRE_TALISMAN(1442, 5537, 16, 14, Location.create(3315, 3254, 0), Location.create(2576, 4845, 0), 2456, 14901, 554, 7, false),
	BODY_TALISMAN(1446, 5533, 32, 20, Location.create(3053, 3443, 0), Location.create(2521, 4834, 0), 2457, 2483, 559, 7.5, false),
	COSMIC_TALISMAN(1454, 5539, 64, 27, Location.create(2409, 4375, 0), Location.create(2122, 4833, 0), 2458, 2484, 564, 8, true),
	CHAOS_TALISMAN(1452, 5543, 512, 35, Location.create(3058, 3591, 0), Location.create(2281, 4837, 0), 2461, 2487, 562, 8.5, true),
	NATURE_TALISMAN(1462, 5541, 256, 44, Location.create(2869, 3021, 0), Location.create(2400, 4835, 0), 2460,2486, 561, 9, true),
	LAW_TALISMAN(1458, 5545, 128, 54, Location.create(2858, 3379, 0), Location.create(2464, 4818, 0), 2459, 2485, 563, 9.5, true),
	DEATH_TALISMAN(1456, 5547, 0, 65, Location.create(3087, 3496, 0), Location.create(2208, 4830, 0), -1, 2488, 560, 10, true),//No Mapdata for outside alter
	BLOOD_TALISMAN(1450, 5549, 0, 77, Location.create(3087, 3496, 0), Location.create(2467, 4888, 1), -1, 30624, 565, 10.5, true),//Don't know coords
	ELEMENTAL_TALISMAN(5516, -1, 0, 1, Location.create(3222, 3222, 0), Location.create(3222, 3222, 0), -1, -1, -1, 0, true),//No idea
	OMNI_TALISMAN(13649, 13655, 0, 1, Location.create(3222, 3222, 0), Location.create(3222, 3222, 0), -1, -1, -1, 0, true)//No idea
	;
	/**
