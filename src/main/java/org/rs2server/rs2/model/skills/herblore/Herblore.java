...
public class Herblore extends ProductionAction {
	...
	public String getSuccessfulProductionMessage() {
		switch(herbloreType) {
		case PRIMARY_INGREDIENT:
			return "You put the " + CacheItemDefinition.get(primaryIngredient.getId()).getName().replaceAll(" clean", "").replaceAll(" leaf", "").toLowerCase() + " into the vial of water.";
		case SECONDARY_INGREDIENT:
			return "You mix the " + CacheItemDefinition.get(secondaryIngredient.getId()).getName().toLowerCase() + " into your potion.";
		}
		return "";
	}
