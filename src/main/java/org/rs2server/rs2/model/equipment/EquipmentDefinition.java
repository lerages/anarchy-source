...
public class EquipmentDefinition {
	...
	private static EquipmentAnimations DEFAULT_ANIMATIONS = new EquipmentAnimations(Animation.create(808), Animation.create(819), Animation.create(824), new Animation[] { Animation.create(422), Animation.create(423), Animation.create(422), Animation.create(422) },
			Animation.create(424), Animation.create(823), Animation.create(820),
			Animation.create(821), Animation.create(822));
...
//		def.bonuses = new int[] {-5,	-5,	-5,	-5,	+10, +6,	+8,	+10,	+10,	+8,	+12, 0, 0, 0};
