...
public class SpiritualMage extends AbstractCombatAction {
	...
	public void hit(final Mob attacker, final Mob victim) {
		...
		attacker.playProjectile(Projectile.create(attacker.getCentreLocation(), victim.getCentreLocation(), 78, 45, 50, clientSpeed, 43, 35, victim.getProjectileLockonIndex(), 10, 48));
