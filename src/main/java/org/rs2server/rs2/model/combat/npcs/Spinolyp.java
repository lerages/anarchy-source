...
public class Spinolyp extends AbstractCombatAction {
	...
	public void hit(final Mob attacker, final Mob victim) {
		...
		case MAGIC:
			...
			attacker.playProjectile(Projectile.create(attacker.getCentreLocation(), victim.getCentreLocation(), 94, 45, 50, clientSpeed, 10, 35, victim.getProjectileLockonIndex(), 10, 48));
