...
public class MeleeCombatAction extends AbstractCombatAction {
	...
	public void hit(final Mob attacker, final Mob victim) {
		...
		final int maxHit = CombatFormulae.calculateMeleeMaxHit(attacker, victim, special);
	...
	public int distance(Mob attacker) {
		return 1;/*attacker.getEquipment() != null && attacker.getEquipment().contains(3204) ? 2 : 1;*/
	}
