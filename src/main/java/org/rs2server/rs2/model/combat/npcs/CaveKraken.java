 ...
 *
 */
public class CaveKraken extends AbstractCombatAction {
	
	/**
	 * The singleton instance.
	 */
	private static final CaveKraken INSTANCE = new CaveKraken();
	...
	public void hit(final Mob attacker, final Mob victim) {
		...
		case MAGIC:
			...
			attacker.playProjectile(Projectile.create(attacker.getCentreLocation(), victim.getCentreLocation(), 162, 45, 50, clientSpeed, 10, 35, victim.getProjectileLockonIndex(), 10, 48));
