...
public class Kamil extends AbstractCombatAction {
	...
	public void hit(final Mob attacker, final Mob victim) {
		...
		case MELEE:
			...
			int randomHit = Misc.random(damage(24, attacker, victim, AttackType.CRUSH, Skills.ATTACK , Prayers.PROTECT_FROM_MELEE, false, false));
		...
		case MAGIC:
			...
			randomHit = damage(5, attacker, victim, AttackType.MAGIC, Skills.MAGIC , Prayers.PROTECT_FROM_MAGIC, false, true);
			if (randomHit > 0) {
