 ...
 *
 */
public class Vetion extends AbstractCombatAction {
	
	/**
	 * The singleton instance.
	 */
	private static final Vetion INSTANCE = new Vetion();
	private static final String[] MESSAGES = {"Death to our enemies!",
			"Prepare to die!",
	...
	public void hit(final Mob attacker, final Mob victim) {
		...
		case MELEE:
			...
			randomHit = super.damage(maxHit, attacker, victim, AttackType.CRUSH, Skills.ATTACK, Prayers.PROTECT_FROM_MELEE, false, false);
