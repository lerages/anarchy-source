...
public class Dessourt extends AbstractCombatAction {
	...
	public void hit(final Mob attacker, final Mob victim) {
		...
		case MAGIC:
			...
			attacker.playProjectile(Projectile.create(attacker.getCentreLocation(), victim.getCentreLocation(), 596, 45, 50, clientSpeed, 43, 35, victim.getProjectileLockonIndex(), 10, 48));
