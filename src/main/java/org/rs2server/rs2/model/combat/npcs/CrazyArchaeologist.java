	    ...
	    public void hit(final Mob attacker, final Mob victim) {
	        ...
	        switch (style) {
	            case RANGE:
	                ...
	                attacker.playProjectile(Projectile.create(attacker.getCentreLocation(), victim.getCentreLocation(), MAGIC_GFX, 45, 50, clientSpeed, 43, 35, victim.getProjectileLockonIndex(), 10, 48));
	                randomHit = damage(31, attacker, victim, CombatState.AttackType.RANGE, Skills.RANGE, Prayers.PROTECT_FROM_MISSILES, false, false);
	        ...
	        World.getWorld().submit(new Tickable((gfxDelay / 20) - 1) {
	            ...
	            public void execute() {
					...
					int finalHit = preStyle == CombatStyle.RANGE ? Misc.random(31) : hit;
