...
public class ZaklnGritch extends AbstractCombatAction {
	...
	public void hit(final Mob attacker, final Mob victim) {
		...
		attacker.playProjectile(Projectile.create(attacker.getCentreLocation(), victim.getCentreLocation(), 1223, 45, 50, rClientSpeed, 43, 35, victim.getProjectileLockonIndex(), 10, 48));
		blockAnimation = true;
		randomHit = damage(maxHit, attacker, victim, AttackType.RANGE, Skills.RANGE, Prayers.PROTECT_FROM_MISSILES, false, false);
