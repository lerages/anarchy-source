...
public class ItemSpawn {
	 ...
	 */
	private GroundItemDefinition groundItem;
	...
	public static void init() throws IOException {
		...
		if(file.exists()) {
			...
			for(ItemSpawn spawn : spawns) {
				groundItemService.createGroundItem(null, new GroundItemService.SpawnedGroundItem(spawn.getItem(), spawn.getLocation(), "", true));
			}
