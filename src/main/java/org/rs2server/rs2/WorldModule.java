...
import org.rs2server.rs2.tickable.impl.GitCommitTick;
...
//		eventBinder.addBinding().to(ShopRestoreTick.class);
		...
		//eventBinder.addBinding().to(RandomMessage1Tick.class);
        eventBinder.addBinding().to(PestControlEvent.class);
		//eventBinder.addBinding().to(BountyHunterEvent.class);
