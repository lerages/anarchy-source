...
public class GourmetImpJar {
    ...
    private static final Item GourmetImpJar = new Item(11240);
    private final Random random;

    public GourmetImpJar(Player player) {
        this.player = player;
    ...
    public Optional<Item> getRewardItem() {
        ...
        if (!player.getInventory().hasItem(GourmetImpJar)) {
