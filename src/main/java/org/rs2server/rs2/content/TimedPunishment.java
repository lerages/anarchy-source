...
public class TimedPunishment {
	...
	public void punish(PunishmentType type, DateTime toPunish) {
		if (type == PunishmentType.MUTE) {
			...
			player.getActionSender().sendMessage("You have been muted for: " + Days.daysBetween(getPunishmentStart(), getPunishmentEnd()).getDays() + " days and " + Hours.hoursBetween(getPunishmentStart(), getPunishmentEnd()).getHours() % 24 + " hours and " + Minutes.minutesBetween(getPunishmentStart(), getPunishmentEnd()).getMinutes() % 60 + " minutes");
