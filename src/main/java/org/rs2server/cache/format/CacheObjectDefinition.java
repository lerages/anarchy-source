												...
												if (i != 28) {
													if (i == 29) {
														...
														for (int i_3_ = 0; (i_2_ ^ 0xffffffff) < (i_3_ ^ 0xffffffff); i_3_++) {
															srcModelColors[i_3_] = (short) class23_sub5.readShortLE((byte) -125);
															destModelColors[i_3_] = (short) class23_sub5.readShortLE((byte) -109);
														}
													} else if (i == 41) {
														...
														for (int i_5_ = 0; (i_5_ ^ 0xffffffff) > (i_4_ ^ 0xffffffff); i_5_++) {
															aShortArray3742[i_5_] = (short) class23_sub5.readShortLE((byte) -124);
															aShortArray3802[i_5_] = (short) class23_sub5.readShortLE((byte) -109);
														}
													} else if (i == 42) {
														...
														if (i != 62) { 
															if (i == 64) {
																...
																if (i != 70) {
																	if (i != 71) {
																		if (i == 72) {
																			anInt3748 = class23_sub5.readUnsignedSmart();
																		} else if (i == 73) {
																			aBoolean3785 = true;
																		} else if (i == 74) {
																			notCliped = true;
																			...
																			if (i == 78) {
																				anInt3743 = class23_sub5.readShortLE((byte) -111);
																				anInt3788 = class23_sub5.readByte() & 0xff;
																			} else if (i != 79) {
																				if (i != 81) {
																					if (i != 82 && i != 88) {
																						if (i == 89) {
																							...
																							if (i != 93) {
																								...
																								aByte3766 = (byte) 3;
																								aShort3789 = (short) class23_sub5.readShortLE((byte) -104);
																							}
																						} else {
																							aBoolean3759 = true;
																						}
																					...
																					aByte3766 = (byte) 2;
																					aShort3789 = (short) (class23_sub5.readByte() & 0xff * 256);
																				}
																			} else {
																				anInt3755 = class23_sub5.readShortLE((byte) -112);
																				anInt3782 = class23_sub5.readShortLE((byte) -120);
																				anInt3788 = class23_sub5.readByte() & 0xff;
																				int i_8_ = class23_sub5.readByte() & 0xff;
																				anIntArray3801 = new int[i_8_];
																				for (int i_9_ = 0; (i_9_ ^ 0xffffffff) > (i_8_ ^ 0xffffffff); i_9_++)
																					anIntArray3801[i_9_] = class23_sub5.readShortLE((byte) -109);
																			}
																		} else {
																			playerVariable = class23_sub5.readShort();
																			if ((playerVariable ^ 0xffffffff) == -65536) {
																				playerVariable = -1;
																			}
																			playerSetting = class23_sub5.readShort();
																			int i_10_ = -1;
																			if ((playerSetting ^ 0xffffffff) == -65536) {
																				playerSetting = -1;
																			}
																			/*if (i == 92) {
																				i_10_ = class23_sub5.readShortLE((byte) -116);
																				if (i_10_ == 65535) {
																					i_10_ = -1;
																				}
																			}*/
																			...
																			for (int i_12_ = 0; (i_12_ ^ 0xffffffff) >= (i_11_ ^ 0xffffffff); i_12_++) {
																				anIntArray3746[i_12_] = class23_sub5.readShort();
...
//		if (obj.objectName != null && obj.objectName.equals("Door") && obj.anIntArray3767 != null && obj.anIntArray3799 != null && obj.getOptions()[0] != null && obj.destModelColors != null && obj.srcModelColors != null) {
//			definitions.values().stream().filter(a -> a.anIntArray3767 != null && a.anIntArray3799 != null && a.getOptions()[0] != null && a.srcModelColors != null && a.destModelColors != null).forEach(a -> {
//				boolean same = obj.anIntArray3767.length == a.anIntArray3767.length
//				&& obj.srcModelColors.length == a.srcModelColors.length && obj.destModelColors.length == a.destModelColors.length;
//
//				if (same) {
//					for (int o = 0; o < obj.anIntArray3767.length; o++) {
//						if (obj.anIntArray3767[o] != a.anIntArray3767[o]) {
//							same = false;
//							break;
//						}
//					}
//
//					if (same) {
//						for (int o = 0; o < obj.anIntArray3799.length; o++) {
//							if (obj.anIntArray3799[o] != a.anIntArray3799[o]) {
//								same = false;
//								break;
//							}
//						}
...
//
//					if (same) {
//						for (int o = 0; o < obj.srcModelColors.length; o++) {
//							if (obj.srcModelColors[o] != a.srcModelColors[o]) {
//								same = false;
//								break;
//							}
//						}
...
//
//					if (same) {
//						for (int o = 0; o < obj.destModelColors.length; o++) {
//							if (obj.destModelColors[o] != a.destModelColors[o]) {
//								same = false;
//								break;
//							}
//						}
...
//
//				if (same) {
//					boolean closed = a.getOptions()[0].toLowerCase().equals("open");
//					boolean open = obj.getOptions()[0].toLowerCase().equals("close");
//
//					if (closed && open) {
//						System.out.println(obj.id+"(open) has the same models as "+a.id+"(closed)");
//						a.opposite = obj.id;
//						obj.opposite = a.id;
//					}
////				} else {
////					CacheObjectDefinition minus = CacheObjectDefinition.forID(obj.id - 1);
////
////					if (minus != null && minus.objectName.equals("Door")) {
////						boolean closed = a.getOptions()[0].toLowerCase().equals("open");
////						boolean open = obj.getOptions()[0].toLowerCase().equals("close");
////
////						if (closed && open) {
////							if (obj.id == 7122)
////								System.out.println("[MINUS] " + obj.id+"(open) has the same models as "+a.id+"(closed)");
////							a.opposite = obj.id;
////							obj.opposite = a.id;
////						}
////					}
