...
public class HTTPServer {
	...
	public static void start() {
		...
		WorldList w1 = new WorldList(1, 33, "35.192.15.114", "Economy", 43594);//43594
		WorldList w2 = new WorldList(2, 1029, "35.192.15.114", "PvP", 43595);//40002
		WorldList w3 = new WorldList(3, 536870913, "127.0.0.1", "Deadman Mode", 5555);
		...
		log.info("Kronos WebServer has loaded sucessfuly.");
	}
}
